...
class _ChatPageState extends ConsumerState<ChatPage> {
  ...
  bool _isReloadingSessions = false;
  ...
  void didChangeDependencies() {
    ...
    if (_hasLoadedSessions) return;
    _hasLoadedSessions = true;
    _reloadSessions();
  }

  void _reloadSessions() {
    if (_isReloadingSessions) return;
    _isReloadingSessions = true;
